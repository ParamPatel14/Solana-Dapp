...
Objective: Establish the "On-Chain Source of Truth."
    ...
    [ ] Task 1.1: Initialize Anchor Project
    ...
    [ ] Task 1.3: Oracle-Verified Mint Instruction
...
Objective: Handle the "Heavy Lifting" off-chain.
    ...
    [ ] Task 3.1: Express/TypeScript Setup
    ...
    [ ] Task 3.2: Helius Webhook Listener
...
Objective: User Interface & "Blinks" for global access.
    ...
    [ ] Task 4.1: Wallet Adapter & UI Layout
    ...
    [ ] Task 4.3: Solana Actions (Blinks)
...
Objective: "In the Field" farmer tools.
    ...
    [ ] Task 5.1: Expo & SMS Configuration
